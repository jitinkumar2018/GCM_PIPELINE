                ...
                script
                 {
                    ...
                    cmd = "sshpass -p ${env.VCSA_PASSWORD} ssh -o StrictHostKeyChecking=no root@${env.VCSA_IP} ./Create_WCP_Namespaces.sh ${env.WCP_NAMESPACE_END} ${env.WCP_NAMESPACE_BEGIN} ${STORAGE_CLASS} ${env.WCP_NAMESPACE_PREFIX} ${env.CLUSTER_NAME}"   
                    sh cmd
                   }
